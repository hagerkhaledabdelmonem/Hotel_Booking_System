...
<report name="employee" DTDVersion="9.0.2.0.10">
  <xmlSettings xmlTag="EMPLOYEE" xmlPrologType="text">
...
<td> <INPUT TYPE="button"  VALUE=" >>" onClick="last(this.form)">
  ...
  <data>
    <userParameter name="job" datatype="character" precision="10" label="Job"
    ...
    <dataSource name="Q_1">
      <select>
      <![CDATA[SELECT ALL EMPLOYEE_PROJECT.SSN, 
EMPLOYEE_PROJECT.BIRTH_DATE, EMPLOYEE_PROJECT.SALARY, EMPLOYEE_PROJECT.SUPERVISOR_SNN, 
EMPLOYEE_PROJECT.LAST_NAME, EMPLOYEE_PROJECT.FIRST_NAME
...
where emp_job= :job ;
      ...
      <group name="G_SSN">
        ...
        <dataItem name="SSN" oracleDatatype="number" columnOrder="11"
         ...
         defaultLabel="Ssn">
          <dataDescriptor expression="EMPLOYEE_PROJECT.SSN"
           descriptiveExpression="SSN" order="1" oracleDatatype="number"
           width="22" precision="15"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <summary name="TotalSALARYPerSSN" source="SALARY"
         function="percentOfTotal" width="22" precision="9" reset="G_SSN"
         compute="report" defaultWidth="110000" defaultHeight="10000"
         columnFlags="520" defaultLabel="% of Total:">
          <displayInfo x="0.00000" y="0.00000" width="0.00000"
           height="0.00000"/>
        </summary>
      </group>
      <group name="G_FIRST_NAME">
        <displayInfo x="0.79138" y="3.31958" width="2.41736" height="1.33936"
        />
        <dataItem name="FIRST_NAME" datatype="vchar2" columnOrder="16"
         ...
         defaultLabel="First Name">
          <dataDescriptor expression="EMPLOYEE_PROJECT.FIRST_NAME"
           descriptiveExpression="FIRST_NAME" order="6" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="LAST_NAME" datatype="vchar2" columnOrder="15"
         defaultWidth="100000" defaultHeight="10000" columnFlags="33"
         defaultLabel="Last Name">
          <dataDescriptor expression="EMPLOYEE_PROJECT.LAST_NAME"
           descriptiveExpression="LAST_NAME" order="5" width="10"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="BIRTH_DATE" datatype="date" oracleDatatype="date"
         ...
         columnFlags="33" defaultLabel="Birth Date">
          <dataDescriptor expression="EMPLOYEE_PROJECT.BIRTH_DATE"
           descriptiveExpression="BIRTH_DATE" order="2" oracleDatatype="date"
           width="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="SALARY" oracleDatatype="number" columnOrder="13"
         ...
         columnFlags="33" defaultLabel="Salary">
          <dataDescriptor expression="EMPLOYEE_PROJECT.SALARY"
           descriptiveExpression="SALARY" order="3" oracleDatatype="number"
           width="22" precision="9"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <dataItem name="SUPERVISOR_SNN" oracleDatatype="number"
         columnOrder="14" width="22" defaultWidth="90000"
         defaultHeight="10000" columnFlags="33" defaultLabel="Supervisor Snn">
          <dataDescriptor expression="EMPLOYEE_PROJECT.SUPERVISOR_SNN"
           descriptiveExpression="SUPERVISOR_SNN" order="4"
           oracleDatatype="number" width="22" precision="15"/>
          <dataItemPrivate adtName="" schemaName=""/>
        </dataItem>
        <summary name="TotalSALARYPerFIRST_NAME" source="SALARY"
         function="percentOfTotal" width="22" precision="9"
         reset="G_FIRST_NAME" compute="G_SSN" defaultWidth="110000"
         ...
         minWidowRecords="1" columnMode="no">
          ...
          <frame name="M_G_FIRST_NAME_GRPFR">
            ...
            <repeatingFrame name="R_G_FIRST_NAME" source="G_FIRST_NAME"
             printDirection="down" minWidowRecords="1" columnMode="no">
              ...
              <field name="F_LAST_NAME" source="LAST_NAME" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="0.75000" y="0.37500" width="0.75000"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              ...
              <field name="F_SALARY" source="SALARY" minWidowLines="1"
               spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="2.87500" y="0.37500" width="1.62500"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <field name="F_SUPERVISOR_SNN" source="SUPERVISOR_SNN"
              ...
              <field name="F_TotalSALARYPerFIRST_NAME"
               source="TotalSALARYPerFIRST_NAME" minWidowLines="1"
               formatMask="NNNNNNNNNNN0D00%" spacing="0" alignment="start">
                <font face="helvetica" size="10"/>
                <geometryInfo x="5.87500" y="0.37500" width="1.62500"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
            </repeatingFrame>
            <frame name="M_G_FIRST_NAME_FTR">
              ...
              <field name="F_TotalSALARYPerSSN" source="TotalSALARYPerSSN"
               minWidowLines="1" formatMask="NNNNNNNNNNN0D00%" spacing="0"
               alignment="start">
                <font face="helvetica" size="10" bold="yes"/>
                <geometryInfo x="2.87500" y="0.56250" width="1.62500"
                 height="0.18750"/>
                <generalLayout verticalElasticity="expand"/>
              </field>
              <text name="B_of_Total_" minWidowLines="1">
            ...
            <frame name="M_G_FIRST_NAME_HDR">
              ...
              <text name="B_LAST_NAME" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="0.75000" y="0.18750" width="0.75000"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="r25g50b75"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
              ...
              <text name="B_BIRTH_DATE" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="1.50000" y="0.18750" width="1.37500"
                 height="0.18750"/>
              ...
              <text name="B_SALARY" minWidowLines="1">
                <textSettings spacing="0"/>
                <geometryInfo x="2.87500" y="0.18750" width="1.62500"
                 height="0.18750"/>
                <visualSettings fillBackgroundColor="TableHeading"/>
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
              ...
              <text name="B_SUPERVISOR_SNN" minWidowLines="1">
                <textSettings spacing="0"/>
                ...
                <textSegment>
                  <font face="helvetica" size="10" bold="yes"
                   textColor="white"/>
                  <string>
                  <![CDATA[Supervisor Snn]]>
                  </string>
                </textSegment>
              </text>
              <text name="B_TotalSALARYPerFIRST_NAME" minWidowLines="1">
                <textSettings spacing="0"/>
...
DCDCDCDC DCDCDCDC DCDCDCDC DCDCDFDF
  ...
  <parameterForm>
  <text name="PB_job" pageNumber="1" minWidowLines="1">
    <textSettings spacing="single"/>
    <geometryInfo x="0.33691" y="1.58679" width="0.24976" height="0.14929"/>
  ...
  <field name="PF_job" source="job" pageNumber="1" minWidowLines="1"
   spacing="0">
    <font size="0"/>
    <geometryInfo x="1.05212" y="1.53430" width="2.00000" height="0.26428"/>
    <visualSettings lineWidth="1" linePattern="solid"/>
  </field>
  <text name="PB_2" pageNumber="1" minWidowLines="1">
    <textSettings spacing="single"/>
    <geometryInfo x="1.23267" y="0.49304" width="1.56226" height="0.18042"/>
    <visualSettings lineWidth="1"/>
    <textSegment>
      <font face="MS Sans Serif" size="10" bold="yes"/>
      <string>
      <![CDATA[Please select the job]]>
      </string>
    </textSegment>
  </text>
  <text name="PB_1" pageNumber="1" minWidowLines="1">
    <textSettings spacing="single"/>
    <geometryInfo x="1.27441" y="0.15979" width="1.47888" height="0.22205"/>
    <visualSettings lineWidth="1"/>
    <textSegment>
...
<rw:dataArea id="MGSSNGRPFR120">
<rw:foreach id="RGSSN1201" src="G_SSN">
<!-- Start GetGroupHeader/n --> <table class="OraTable">
 <caption class="OraHeader">  <br>Ssn <rw:field id="F_SSN" src="SSN" breakLevel="RGSSN1201" breakValue="&nbsp;"> F_SSN </rw:field><br>
 </caption>
<!-- End GetGroupHeader/n -->   <tr>
    ...
    <table class="OraTable" summary="">
     ...
     <thead>
      <tr>
       <th <rw:id id="HBFIRSTNAME120" asArray="no"/> class="OraColumnHeader"> First Name </th>
       <th <rw:id id="HBLASTNAME120" asArray="no"/> class="OraColumnHeader"> Last Name </th>
       <th <rw:id id="HBBIRTHDATE120" asArray="no"/> class="OraColumnHeader"> Birth Date </th>
       <th <rw:id id="HBSALARY120" asArray="no"/> class="OraColumnHeader"> Salary </th>
       <th <rw:id id="HBSUPERVISORSNN120" asArray="no"/> class="OraColumnHeader"> Supervisor Snn </th>
       <th <rw:id id="HBTotalSALARYPerFIRSTNAME120" asArray="no"/> class="OraColumnHeader"> % of Total: </th>
      </tr>
     </thead>
     <!-- Body -->
     <tbody>
      <rw:foreach id="RGFIRSTNAME1201" src="G_FIRST_NAME">
       <tr>
        <td <rw:headers id="HFFIRSTNAME120" src="HBFIRSTNAME120"/> class="OraCellText"><rw:field id="FFIRSTNAME120" src="FIRST_NAME" nullValue="&nbsp;"> F_FIRST_NAME </rw:field></td>
        <td <rw:headers id="HFLASTNAME120" src="HBLASTNAME120"/> class="OraCellText"><rw:field id="FLASTNAME120" src="LAST_NAME" nullValue="&nbsp;"> F_LAST_NAME </rw:field></td>
        <td <rw:headers id="HFBIRTHDATE120" src="HBBIRTHDATE120"/> class="OraCellText"><rw:field id="FBIRTHDATE120" src="BIRTH_DATE" nullValue="&nbsp;"> F_BIRTH_DATE </rw:field></td>
        <td <rw:headers id="HFSALARY120" src="HBSALARY120"/> class="OraCellNumber"><rw:field id="FSALARY120" src="SALARY" nullValue="&nbsp;"> F_SALARY </rw:field></td>
        <td <rw:headers id="HFSUPERVISORSNN120" src="HBSUPERVISORSNN120"/> class="OraCellNumber"><rw:field id="FSUPERVISORSNN120" src="SUPERVISOR_SNN" nullValue="&nbsp;"> F_SUPERVISOR_SNN </rw:field></td>
        <td <rw:headers id="HFTotalSALARYPerFIRSTNAME120" src="HBTotalSALARYPerFIRSTNAME120"/> class="OraCellNumber"><rw:field id="FTotalSALARYPerFIRSTNAME120" src="TotalSALARYPerFIRST_NAME" nullValue="&nbsp;"> F_TotalSALARYPerFIRST_NAME </rw:field></td>
       </tr>
      </rw:foreach>
     </tbody>
     <tr>
      ...
      <th class="OraTotalText"> &nbsp; </th>
      <th class="OraTotalText"> &nbsp; </th>
      <td <rw:headers id="HFTotalSALARYPerSSN120" src="HBSALARY120"/> class="OraTotalNumber">% of Total: <rw:field id="FTotalSALARYPerSSN120" src="TotalSALARYPerSSN" nullValue="&nbsp;"> F_TotalSALARYPerSSN </rw:field></td>
      <th class="OraTotalText"> &nbsp; </th>
      <th class="OraTotalText"> &nbsp; </th>
     </tr>
     <tr>
